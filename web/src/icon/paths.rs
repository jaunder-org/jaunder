...
impl Icons {
    ...
    pub const MINUS: &'static str = "M4 10h12";
    pub const COPY: &'static str = "M7 6h9v11H7z M4 14H3V3h9v1";
    ...
    pub const SAVE: &'static str = "M4 3h10l3 3v11H3V3z M6 3v5h8V3 M6 17v-5h8v5";
