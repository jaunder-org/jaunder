...
> **Update (#227):** in #227 the feature became enabled by `JAUNDER_CAPTURE_DIR`
> (the server writes `diag.log` within it) rather than the standalone
...
> consumption — was otherwise unchanged. See the capture-dir contract ADR
