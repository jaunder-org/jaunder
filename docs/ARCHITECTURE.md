...
exported
([trusted proxy client-IP derivation](adr/0205-trusted-proxy-client-ip.md)).
...
([trusted proxy client-IP derivation](adr/0205-trusted-proxy-client-ip.md)). The
minimal NixOS module exposes `services.jaunder.trustedProxies`, an empty-by-
...
[trusted proxy client-IP derivation](adr/0205-trusted-proxy-client-ip.md). It
...
makes it direct and every other such context is optional. Thus a directly or
