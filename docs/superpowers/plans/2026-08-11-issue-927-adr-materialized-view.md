...
| **ADR-0028** frames `devtool` as the crate that runs _inside_ the Nix build. `devtool run` and `devtool check` are host-invoked by design. The litmus test still holds; the framing sentence no longer covers the whole surface.                                                                                                                                                                                                                                                               | Task 18 |
