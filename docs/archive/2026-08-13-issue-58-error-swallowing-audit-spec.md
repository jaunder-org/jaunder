...
This is delivery evidence only; it does not revise AC1-AC23 or Decisions D1-D11.
Commands shown as delivered were recorded by the owning committed plan tasks.
Task 12 controller reruns are recorded below only when their command completed
successfully against the reconciled tree.

| Criterion | Delivered commit/test evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Task 12/controller status                                                                                                                      |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| AC1       | Baseline `85b06152e64c508835c528e8957ec53f4ac9d0d4`; final inventory now reconciles 1,389 raw records → 952 included records → 957 expression occurrences → 899 key-family memberships → 873 recipe keys plus 17 manual conclusions (890 total), with 88 frozen/delivered keys. The checker retains all 11 focused production-parser tests. Exact site-specific proofs now exist for `devtool.coverage.crap_artifact` and the wasm session-marker read failure.                                                                                                                                                                                                                 | Counts, keys, ledger, and proof ownership reconciled; all Task 12 focused suites, browser proofs, and the dirty-tree validation matrix passed. |
| AC2       | `24120d3765216cf32c49b18793162b6c9507a6b7`; `use_email_verification_with_closed_pool_returns_internal`; `cargo nextest run -p storage email_verification`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Delivered.                                                                                                                                     |
| AC3       | `24120d3765216cf32c49b18793162b6c9507a6b7`; invite claim surface removed; `cargo nextest run -p storage create_user_with_invite`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Delivered.                                                                                                                                     |
| AC4       | `24120d3765216cf32c49b18793162b6c9507a6b7`; `confirm_password_reset_with_closed_pool_returns_error`; `cargo nextest run -p storage confirm_password_reset`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Delivered.                                                                                                                                     |
| AC5       | `54c47f3f78543e11aad12d58a449093fa48ce7ad`; `report_swallowed` event/metric tests; `cargo nextest run -p host error`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Delivered.                                                                                                                                     |
| AC6       | `54c47f3f78543e11aad12d58a449093fa48ce7ad`; boundary disposition/origin assertions; `cargo nextest run -p web --features server boundary_failure`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Delivered.                                                                                                                                     |
| AC7       | `893a047ac5603f91d1921df4e0da1d30d14b2c17` wire-shape tests and `db6f79dc0894f6703c38bc3d168b017ef8429195` HTTP rejection tests; `cargo nextest run -p common client_telemetry` and `-p jaunder client_telemetry`.                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Delivered.                                                                                                                                     |
| AC8       | `db6f79dc0894f6703c38bc3d168b017ef8429195`; backend-parametric accepted cookie/intake event+metric tests; `cargo nextest run -p jaunder client_telemetry`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Delivered.                                                                                                                                     |
| AC9       | `db6f79dc0894f6703c38bc3d168b017ef8429195`; injected-clock limiter and silent-429 HTTP tests; `cargo nextest run -p jaunder client_telemetry`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Delivered.                                                                                                                                     |
| AC10      | `893a047ac5603f91d1921df4e0da1d30d14b2c17` reporter state-machine tests and `a1eec51d2e9fbd51476a84f362663fa567fba2b4` `client-telemetry.spec.ts`; `cargo nextest run -p client telemetry`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Delivered; Task 12 browser rerun passed.                                                                                                       |
| AC11      | `a1eec51d2e9fbd51476a84f362663fa567fba2b4`; audited caller classification tests and real authenticated browser-to-intake proof. The follow-up browser case `session marker read failure reports before authenticated recovery` owns the remaining marker-read continuation proof using the Rust-owned seed-record key.                                                                                                                                                                                                                                                                                                                                                          | Delivered; Task 12 browser rerun passed.                                                                                                       |
| AC12      | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1`; `default_post_format`, `audience_picker`, `profile.spec.ts`, and `posts.spec.ts`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Delivered; Task 12 host and browser reruns passed.                                                                                             |
| AC13      | `d1df5a0376e7720d15908bbe1d02584f9a0d0ab5`; `mailer_source_chain`; `cargo nextest run -p jaunder mailer`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Delivered.                                                                                                                                     |
| AC14      | `99beee99d9a9bea967c11840a004f24b438627ee`; media classifier/source/boundary tests and deterministic disappearance HTTP proof; `cargo nextest run -p jaunder media`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Delivered.                                                                                                                                     |
| AC15      | `d1df5a0376e7720d15908bbe1d02584f9a0d0ab5`; `auto_init`, PostgreSQL guidance, and real missing-database integration proofs; `cargo nextest run -p jaunder commands`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Delivered.                                                                                                                                     |
| AC16      | `99beee99d9a9bea967c11840a004f24b438627ee`; permalink/timeline/tag diagnostics tests; `cargo nextest run -p jaunder projector`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Delivered.                                                                                                                                     |
| AC17      | `2bf26e482a1aad1bcde6ba195bb459c9ea9b9e71`; `continuation_reporting`, `feed`, `backup`, `runtime_file`, and `websub` focused suites.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Delivered.                                                                                                                                     |
| AC18      | `2536994a3359f63de17f5e8b7f109cb890f4e4dd` plus follow-up `cc981308`; `fail_closed_population`, `stale_worktree_registry_query_failure_is_typed`, `gh_source_resolve_distinguishes_absent_git_facts_from_failures`, build staging, trace JSON, e2e PATH, Nix directory-population, and primary-output propagation proofs.                                                                                                                                                                                                                                                                                                                                                       | Delivered; Task 12 focused suites and dirty-tree validation matrix passed.                                                                     |
| AC19      | `2536994a3359f63de17f5e8b7f109cb890f4e4dd` plus follow-up `cc981308`; `ancillary_warning_stream_summary_failures_preserve_fallback_and_primary_code`, `ancillary_warning_history_population_failures_warn_once_per_attempt`, `ancillary_warning_git_facts_failures_preserve_optional_facts_and_json`, `ancillary_warning_server_drop_failure_preserves_primary_result`, `ancillary_warning_summary_write_preserves_primary_result_and_json`, `ancillary_warning_build_diagnostic_losses_aggregate_once`, `coverage::emit::tests::ancillary_warning_crap_artifact_failures_preserve_empty_report`, probe-worktree, PostgreSQL teardown, diagnostics, and timeout-cleanup proofs. | Delivered; Task 12 focused suites and dirty-tree validation matrix passed.                                                                     |
| AC20      | `54c47f3f78543e11aad12d58a449093fa48ce7ad`, `893a047ac5603f91d1921df4e0da1d30d14b2c17`, and `db6f79dc0894f6703c38bc3d168b017ef8429195`; observability fallback, delivery terminal callback, and intake rejection tests assert no recursive metric/report.                                                                                                                                                                                                                                                                                                                                                                                                                       | Delivered.                                                                                                                                     |
| AC21      | `85b06152e64c508835c528e8957ec53f4ac9d0d4`; ADR-0011/0017, architecture, contributing policy, and unchanged `CONTEXT.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Delivered.                                                                                                                                     |
| AC22      | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1`; every #898/#899 item is mapped below to host and browser evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Issue closure remains pending the issue #58 PR, as required.                                                                                   |
| AC23      | All focused commands recorded in Tasks 2-11 are tied above to their implementation commits. Task 12 reran every listed focused nextest suite, `client-telemetry.spec.ts`, `profile.spec.ts`, `posts.spec.ts`, `cargo xtask check`, and the complete `cargo xtask validate --allow-dirty` matrix against the reconciled tree.                                                                                                                                                                                                                                                                                                                                                    | Dirty-tree validation matrix passed; clean-tree `cargo xtask validate` remains pending after commit.                                           |

### Inherited #898 and #899 item mapping

| Inherited acceptance item                                  | Delivered behavior/decision                                                                 | Host evidence         | Browser evidence                                            | Commit                                     |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------- | ------------------------------------------ |
| #898: failed read distinguishable from successful Markdown | `DefaultPostFormatState::Failed`; explicit `.error`; Save cannot dispatch.                  | `default_post_format` | `profile.spec.ts` forced-read-failure flow                  | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1` |
| #898: distinction asserted by host test                    | Loading/Ready/Failed decision table, including Ready(Markdown) versus Failed.               | `default_post_format` | `profile.spec.ts` also pins visible behavior                | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1` |
| #899: failure visibly distinct from no audiences           | `NamedAudienceState::Failed` differs from `Ready(Vec::new())`; explicit `.error`.           | `audience_picker`     | `posts.spec.ts` forced-fetch-failure and loaded-empty flows | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1` |
| #899: host test and browser proof                          | Loading/Ready(empty)/Ready(populated)/Failed transitions are host-tested.                   | `audience_picker`     | `posts.spec.ts` mirrors the roster failure contract         | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1` |
| #899: publish gating decision                              | Only `Ready` can submit; Loading and Failed cannot publish or fabricate an empty selection. | `audience_picker`     | `posts.spec.ts` asserts publish remains gated after failure | `ff08e5119b9bf8e50d94f4761a24fceacf6940c1` |
