...
| [0140](adr/0140-strict-media-address-extraction.md) | Cargo Workspace Execution Boundaries and Compensating Host Tests | accepted |
| [0141](adr/0141-cargo-workspace-execution-boundaries.md) | Declarative NixOS Deployment and Package Outputs | accepted |
| [0142](adr/0142-declarative-nixos-deployment-package-outputs.md) | Emacs auth-source App Password Storage | accepted |
| [0143](adr/0143-emacs-auth-source-app-password-storage.md) | Process Configuration and CLI Contract | accepted |
