...
use crate::{InstanceId, MediaDeleteMode};
...
impl MediaDialect for Sqlite {
    ...
    async fn try_delete_media(
        ...
        query.push("))");
        media::push_theme_media_reference_predicate(
            &mut query,
            media,
            &media::ThemeMediaOwner::Exact(user_id),
        );
        ...
        media::push_theme_media_reference_predicate(
            &mut query,
            media,
            &media::ThemeMediaOwner::Other(user_id),
        );
