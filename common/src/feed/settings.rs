...
mod tests {
    ...
    fn min_items_full_surface() {
        assert_eq!("5".parse::<FeedMinItems>().unwrap().get(), 5);
        assert_eq!("  20  ".parse::<FeedMinItems>().unwrap().get(), 20);
        ...
        assert_eq!(FeedMinItems::default().get(), 20);
        ...
        assert_eq!(
            serde_json::from_str::<FeedMinItems>("42").unwrap().get(),
            42
        );
    ...
    fn min_days_full_surface() {
        assert_eq!("7".parse::<FeedMinDays>().unwrap().get(), 7);
        ...
        assert_eq!(FeedMinDays::default().get(), 30);
        ...
        assert_eq!(serde_json::from_str::<FeedMinDays>("15").unwrap().get(), 15);
