...
/// already-valid usernames. The rest of the ADR-0063 string-newtype trailer
/// (`Display`, `AsRef<str>`, `Borrow<str>`, `Deref<Target = str>`, owned `String`
/// conversions, `PartialEq<str>`, and the validating serde bridge) is generated by
/// `#[derive(StrNewtype)]`, so a `Username` serializes as a plain string and rejects
