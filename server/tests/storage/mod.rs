...
async fn post_slug_conflict_returns_slug_conflict(#[case] backend: Backend) {
    ...
    let pub_input = CreatePostInput {
        user_id,
        title: Some("Published".to_string().into()),
...
async fn post_update_writes_revision_and_updates_record(#[case] backend: Backend) {
    ...
    let update_input = UpdatePostInput {
        ...
        body: "updated body".to_string().into(),
...
async fn post_update_by_non_owner_returns_unauthorized(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: owner,
            title: Some("Owned".to_string().into()),
            slug: "owned".parse().unwrap(),
            body: "Content".to_string().into(),
            format: PostFormat::Markdown,
    ...
    let err = state
        ...
        .update_post(
            ...
            other,
            &UpdatePostInput {
                title: Some("Hijacked".to_string().into()),
                slug: "hijacked".parse().unwrap(),
                body: "Nope".to_string().into(),
                format: PostFormat::Markdown,
...
async fn post_audiences_are_persisted_and_replaced(#[case] backend: Backend) {
    ...
    let update_private = UpdatePostInput {
        title: Some("Post audience-post".to_string().into()),
...
async fn get_post_audiences_round_trips(#[case] backend: Backend) {
    ...
    // Subscribers-only.
    let update_subs = UpdatePostInput {
        title: Some("Post round-trip".to_string().into()),
...
async fn multiple_tags_on_single_post(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Multi Tag Post".to_string().into()),
            slug: "multi-tag-post".parse().unwrap(),
            body: "Content with many tags".to_string().into(),
            format: PostFormat::Markdown,
...
async fn empty_tag_list(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("No Tags".to_string().into()),
            slug: "no-tags".parse().unwrap(),
            body: "Untagged post".to_string().into(),
            format: PostFormat::Markdown,
...
async fn list_user_posts_by_tag_excludes_other_users(#[case] backend: Backend) {
    ...
    let post1 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user1,
            title: Some("User1 Post".to_string().into()),
    ...
    let post2 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user2,
            title: Some("User2 Post".to_string().into()),
...
async fn selective_untag(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Multi Tag".to_string().into()),
...
async fn numeric_tag(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Numeric Tag".to_string().into()),
...
async fn retag_same_post_with_same_tag_fails(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Retag Post".to_string().into()),
...
async fn tag_hyphen_boundaries(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Hyphen Test".to_string().into()),
...
async fn tag_with_long_display(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Long Tag Test".to_string().into()),
...
async fn tags_for_multiple_posts(#[case] backend: Backend) {
    ...
    let post1 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Post A".to_string().into()),
            slug: "post-a".parse().unwrap(),
            body: "Content A".to_string().into(),
            format: PostFormat::Markdown,
    ...
    let post2 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Post B".to_string().into()),
            slug: "post-b".parse().unwrap(),
            body: "Content B".to_string().into(),
            format: PostFormat::Markdown,
...
async fn tag_mixed_alphanumeric(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Mixed Post".to_string().into()),
...
async fn simple_tag_lifecycle(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Simple".to_string().into()),
...
async fn list_user_posts_by_tag(#[case] backend: Backend) {
    ...
    let post3 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user2,
            title: Some("Post 3".to_string().into()),
            slug: "post-3".parse().unwrap(),
            body: "Content 3".to_string().into(),
            format: PostFormat::Markdown,
...
async fn draft_posts_excluded_from_tag_list(#[case] backend: Backend) {
    ...
    let post1 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Draft Post".to_string().into()),
            slug: "draft-post".parse().unwrap(),
            body: "Draft content".to_string().into(),
            format: PostFormat::Markdown,
    ...
    let post2 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Published Post".to_string().into()),
            slug: "published-post".parse().unwrap(),
            body: "Published content".to_string().into(),
            format: PostFormat::Markdown,
...
async fn post_update_invalid_slug(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Original".to_string().into()),
    ...
    let _post_id2 = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Second".to_string().into()),
    ...
    let update_result = state
        ...
        .update_post(
            ...
            user,
            &UpdatePostInput {
                title: Some("Updated".to_string().into()),
                slug: "second-slug".parse().unwrap(),
                body: "Updated content".to_string().into(),
                format: PostFormat::Markdown,
...
async fn soft_delete_then_operations(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("To Delete".to_string().into()),
...
async fn tag_post_multiple_attempts(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("For Tagging".to_string().into()),
...
async fn get_by_permalink_soft_deleted(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Permalink Test".to_string().into()),
...
async fn update_soft_deleted_post(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("To Update".to_string().into()),
    ...
    let _result = state
        ...
        .update_post(
            ...
            &UpdatePostInput {
                ...
                body: "New content".to_string().into(),
                format: PostFormat::Markdown,
...
async fn tag_edge_case_formats(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Edge Cases".to_string().into()),
...
async fn post_revisions_created(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            ...
            body: "Original content".to_string().into(),
            format: PostFormat::Markdown,
...
async fn tag_display_preservation(#[case] backend: Backend) {
    ...
    let post_id = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Display Test".to_string().into()),
...
async fn create_rendered_post_markdown_renders_and_stores(#[case] backend: Backend) {
    ...
    let post_id = create_rendered_post(
        ...
        RenderedPostContent {
            user_id,
            title: Some("Rendered Markdown".to_string().into()),
            slug: "rendered-markdown".parse().unwrap(),
            body: "**bold**".to_string().into(),
            format: PostFormat::Markdown,
            published_at: None,
            summary: None,
            audiences: vec![AudienceTarget::Public],
...
async fn create_rendered_post_org_renders_and_stores(#[case] backend: Backend) {
    ...
    let post_id = create_rendered_post(
        ...
        RenderedPostContent {
            user_id,
            title: Some("Rendered Org".to_string().into()),
...
async fn create_rendered_post_slug_conflict_returns_storage_error(#[case] backend: Backend) {
    ...
    create_rendered_post(
        ...
        RenderedPostContent {
            user_id,
            title: Some("First Post".to_string().into()),
    ...
    let err = create_rendered_post(
        ...
        RenderedPostContent {
            user_id,
            title: Some("Second Post".to_string().into()),
            slug: "conflict-slug".parse().unwrap(),
            body: "body".to_string().into(),
            format: PostFormat::Markdown,
            published_at: Some(now),
...
async fn create_post_foreign_key_violation_maps_to_internal(#[case] backend: Backend) {
    ...
    let input = CreatePostInput {
        user_id: 999_999,
        title: Some("Orphan".to_string().into()),
...
async fn update_rendered_post_org_renders_and_updates(#[case] backend: Backend) {
    ...
    let record = update_rendered_post(
        ...
        RenderedPostUpdate {
            post_id,
            editor_user_id: user_id,
            title: Some("Updated Org Title".to_string().into()),
            slug: "update-render-org".parse().unwrap(),
            body: "*bold org*".to_string().into(),
            format: PostFormat::Org,
            publish: PublishUpdate::Unpublish,
            summary: None,
            audiences: vec![AudienceTarget::Public],
...
async fn update_rendered_post_not_found_returns_storage_error(#[case] backend: Backend) {
    ...
    let err = update_rendered_post(
        ...
        RenderedPostUpdate {
            post_id: 99999,
            editor_user_id: 1,
            title: Some("No Post".to_string().into()),
...
async fn list_tags_returns_alphabetical_with_prefix(#[case] backend: Backend) {
    ...
    let post = state
        ...
        .create_post(&CreatePostInput {
            user_id: user,
            title: Some("Tagged".to_string().into()),
