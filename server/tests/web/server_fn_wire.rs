...
wire_contract! {
    ...
    web::media::GetUploadsEnabled => "media" / "get_uploads_enabled",
    web::media::GetUsage => "media" / "get_usage",
    web::media::ListMine => "media" / "list_mine",
    web::media::Upload => "media" / "upload",
    web::passkeys::Availability => "passkeys" / "availability",
    web::passkeys::StartRegistration => "passkeys" / "start_registration",
    web::passkeys::FinishRegistration => "passkeys" / "finish_registration",
    web::passkeys::StartAuthentication => "passkeys" / "start_authentication",
    web::passkeys::FinishAuthentication => "passkeys" / "finish_authentication",
    web::passkeys::List => "passkeys" / "list",
    web::passkeys::Delete => "passkeys" / "delete",
    ...
    web::posts::ExecuteManagementOperation => "posts" / "execute_management_operation",
    ...
    web::posts::ListManagedPosts => "posts" / "list_managed_posts",
    web::posts::ResolveManagementSelection => "posts" / "resolve_management_selection",
    ...
    web::profile::GetDefaultAudience => "profile" / "get_default_audience",
    web::profile::GetDefaultPostFormat => "profile" / "get_default_post_format",
    web::profile::SetDefaultAudience => "profile" / "set_default_audience",
    ...
    web::site::GetDefaultAudience => "site" / "get_default_audience",
    web::site::GetIdentity => "site" / "get_identity",
    web::site::GetMediaUploadsEnabled => "site" / "get_media_uploads_enabled",
    web::site::IsBaseUrlWarningVisible => "site" / "is_base_url_warning_visible",
    web::site::UpdateDefaultAudience => "site" / "update_default_audience",
    ...
    web::themes::List => "themes" / "list",
    web::themes::GetDraft => "themes" / "get_draft",
    web::themes::GetPresentation => "themes" / "get_presentation",
    web::themes::GetSelection => "themes" / "get_selection",
    web::themes::Create => "themes" / "create",
    web::themes::ImportPackage => "themes" / "import_package",
    web::themes::ImportZip => "themes" / "import_zip",
    web::themes::ImportCss => "themes" / "import_css",
    web::themes::ReplaceCss => "themes" / "replace_css",
    web::themes::Export => "themes" / "export",
    web::themes::Rename => "themes" / "rename",
    web::themes::Remove => "themes" / "remove",
    web::themes::Publish => "themes" / "publish",
    web::themes::Select => "themes" / "select",
    web::themes::ReplaceBinding => "themes" / "replace_binding",
    web::themes::ReplacePool => "themes" / "replace_pool",
    web::themes::Shuffle => "themes" / "shuffle",
    web::themes::Preview => "themes" / "preview",
