...
static REGISTRATIONS: LazyLock<()> = LazyLock::new(|| {
    ...
    server_fn::axum::register_explicit::<web::profile::GetDefaultAudience>();
    server_fn::axum::register_explicit::<web::profile::SetDefaultAudience>();
    ...
    server_fn::axum::register_explicit::<web::site::UpdateDefaultAudience>();
