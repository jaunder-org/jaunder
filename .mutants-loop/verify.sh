...
#
# Runs cargo-mutants exactly as discovery ran it (see common.sh) against one
# file, into a scratch output dir, and prints the counts. Anything left in
# `missed` is still alive.
#
